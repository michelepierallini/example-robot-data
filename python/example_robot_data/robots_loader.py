...
class MulinexLoader(RobotLoader):
    path = 'mulinex_description'
    urdf_filename = 'mulinex_robot_mio.urdf'
    srdf_filename = 'mulinex_robot.srdf'
    urdf_subpath = 'urdf'
    ref_posture = 'standing'
    free_flyer = True 
    
class Mulinex12Loader(RobotLoader):
    path = 'mulinex_12_description'
    urdf_filename = 'mulinex_robot_mio.urdf'
    srdf_filename = 'mulinex_robot.srdf'
    urdf_subpath = 'urdf'
    ref_posture = 'standing'
...
class SoftlegLoader(RobotLoader):
    path = "softleg_description"
    urdf_filename = "softleg.urdf"
    urdf_subpath = "urdf"
